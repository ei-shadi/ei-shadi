...
<div style="display: flex; justify-content: center; margin-top: 5rem; margin-bottom: 5rem;">
  <img
    src="https://readme-typing-svg.herokuapp.com?font=Bitcount+Grid+Single&size=48&duration=2500&pause=100000&color=00ffff&center=true&vCenter=true&width=1400&lines=Hi!"
    alt="Typing SVG"
...
<div style="display: flex; justify-content: center; margin-top: 5rem; margin-bottom: 5rem;">
  <img
    src="https://readme-typing-svg.herokuapp.com?font=Bitcount+Grid+Single&size=50&duration=2500&pause=100000&color=b200ff&center=true&vCenter=true&width=1500&lines=🖤Welcome+to+My+Darkside🌚"
    alt="Typing SVG"
    style="max-width: 100%; height: auto;" />
</div>
...
<section id="contact" style="color: #fff; padding: 2rem; background-color: #0e0e0e; border-radius: 10px; max-width: 700px; margin: auto;">
  ...
  <div style="display: flex; justify-content: center; flex-wrap: wrap; margin-top: 1.5rem; gap: 12px;">
    ...
    <a href="mailto:eftajulislam.shaadi@gmail.com" target="_blank">
